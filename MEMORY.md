...
Last Updated: 2026-03-12T20:18:00Z
Updated By: Codex
...
- `C:\dev\sempal` is at commit `3ba1e49d` and matches `origin/next` before the current superproject bookkeeping commit.
...
- Item 8 is next in `tmp/cleanup_plan.md`.
