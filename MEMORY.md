...
Last Updated: 2026-03-14T14:08:00Z
Updated By: Codex
...
- The next active item is backlog item 6: decompose `app_core` projection-cache state and probe logic into narrower ownership layers.
- The highest-leverage current findings are:
  ...
  - Large runtime boundaries remain concentrated in `src/app_core/native_bridge/projection_cache.rs`.
