...
Last Updated: 2026-03-30T10:25:00Z
Updated By: Codex
...
- The remaining top backlog still centers on compare-anchor undo ambiguity, crop-export history inconsistency, pending-rename lifecycle clarification, and the misleading `GuiScenarioStep::CaptureSnapshot` contract.
...
- Active audit plan: `tmp/improvement_audit_plan.md` (rebuilt on 2026-03-30; Phase 2 execution active, item 1 complete)
