...
1. Execute item 2 from `tmp/improvement_audit_plan.md`: record handled/unhandled status in GUI action traces and tighten `ActionRecorded` semantics.
2. Keep `AGENTS.md`, `docs/plans/active/todo.md`, and `docs/plans/index.md` aligned with the active Phase 2 execution state.
3. Continue the backlog in order once item 2 is complete.
...
- Active audit plan: `tmp/improvement_audit_plan.md` (refreshed on 2026-04-01; Phase 2 active, item 1 complete, item 2 next)
