...
- Generated (UTC): `2026-03-17T14:03:14Z`
- Branch: `next`
- Commit: `9bda0d2e`
- Rust files scanned: 886
- File-size budget limit: `400`

## Summary

- Over file-size budget: 7
- Function spans captured: 5586
...
| Lines | File |
| --- | --- |
| 431 | `src/app/controller/tests/drag_drop_drop_targets.rs` |
...
| 389 | `src/sample_sources/db/file_ops_journal/tests.rs` |
...
| 200 | `handle_sample_drop_to_drop_target` (`src/app/controller/ui/drag_drop_controller/drag_effects/drop_targets.rs:37`) |
...
| 407 | `src/selection/range.rs` |
| 386 | `tools/bench-cli/src/bench/gui/interactions.rs` |
| 370 | `src/app/controller/ui/drag_drop_controller/drag_effects/drop_targets.rs` |
