...
- Current status: `tmp/perf_plan.md` is complete through item 11; `tmp/cleanup_plan.md` was refreshed on 2026-03-11 with a new second-pass cleanup backlog; Phase 2 is now in progress, item 1 is complete, and item 2 is next.

## Immediate Next Actions
1. Continue the refreshed cleanup backlog in strict order from item 2.
...
- `tmp/cleanup_plan.md`: refreshed strict ROI-ranked cleanup backlog (Phase 2 in progress; item 1 complete, item 2 next)
