...
- Current status: Phase 2 is active; cleanup items 1-6 are complete, and item 7 is next.
...
- `tmp/cleanup_plan.md`: active strict ROI-ranked cleanup backlog rebuilt on `2026-03-12`; items 1-6 complete, item 7 next
