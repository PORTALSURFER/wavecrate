...
- Current status: Phase 2 is in progress on `2026-03-15`; items 1-5 are complete and the next planned task is hotkey-registry invariant coverage.
...
2. Next up: item 6, add direct hotkey-registry invariant tests around `src/app/controller/ui/hotkeys/actions.rs`.
...
- `tmp/improvement_audit_plan.md`: refreshed evidence-driven ROI-ranked improvement backlog and execution record; items 1-5 are complete as of `2026-03-15`
