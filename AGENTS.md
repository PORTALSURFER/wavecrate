...
- Current status: `tmp/perf_plan.md` is complete through item 11; `tmp/cleanup_plan.md` was refreshed on 2026-03-11 with a new second-pass cleanup backlog; Phase 2 is now in progress, items 1-6 are complete, and item 7 is next.
...
- `tmp/cleanup_plan.md`: refreshed strict ROI-ranked cleanup backlog (Phase 2 in progress; items 1-6 complete, item 7 next)
