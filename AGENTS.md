...
- Current status: `tmp/perf_plan.md` is complete through item 11; `tmp/cleanup_plan.md` is the active cleanup backlog, refreshed on 2026-03-10; items 1-15 are complete, item 16 is next, and Phase 2 is in progress.
...
- `tmp/cleanup_plan.md`: strict ROI-ranked cleanup backlog + execution checklist (last refresh/revalidation: 2026-03-10; items 1-15 complete, item 16 next)
