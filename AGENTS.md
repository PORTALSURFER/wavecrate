...
- Current status: the refreshed cleanup backlog is now in Phase 2 execution; items 1-3 are complete, 13 items remain, and item 4 is next.
...
- `tmp/cleanup_plan.md`: active strict ROI-ranked cleanup backlog (Phase 2 active; items 1-3 complete on 2026-03-11, item 4 next)
