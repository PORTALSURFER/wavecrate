...
- Source of truth: `tmp/improvement_audit_plan.md` for the refreshed ROI-ranked backlog and completed execution record for the current codebase; `docs/gui_test_platform.md`, `tmp/cleanup_plan.md`, and `tmp/perf_plan.md` remain relevant background plans
- Current status: the refreshed evidence-driven improvement audit lane is complete on `2026-03-15`; items 1-8 are implemented and recorded in `tmp/improvement_audit_plan.md`.
...
2. Keep `tmp/improvement_audit_plan.md` as the completed execution record for the latest improvement-audit lane.
...
- `tmp/improvement_audit_plan.md`: refreshed evidence-driven ROI-ranked improvement backlog and execution record for the current tree; items 1-8 are complete as of `2026-03-15`
