...
- Current status: the refreshed cleanup backlog is now in Phase 2 execution; items 1-4 are complete, 12 items remain, and item 5 is next.

## Immediate Next Actions
1. Continue cleanup strictly in `tmp/cleanup_plan.md` order at item 5.
...
- `tmp/cleanup_plan.md`: active strict ROI-ranked cleanup backlog (Phase 2 active; items 1-4 complete on 2026-03-11, item 5 next)
