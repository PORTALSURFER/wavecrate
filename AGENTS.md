...
- Current status: Phase 2 is active on `2026-04-01`. Items 1, 2, 3, and 4 are complete, item 5 (remaining non-allowlisted production/runtime file-size debt) is next, and execution is proceeding in backlog order.
...
2. Continue the backlog strictly in order after item 5, with the oversized test hubs next.
...
- `tmp/improvement_audit_plan.md`: refreshed evidence-driven ROI-ranked improvement backlog and execution record for the live tree; Phase 2 is active, items 1, 2, 3, and 4 are complete, and item 5 is next
