...
- Current status: Phase 2 is active; cleanup items 1-7 are complete, and item 8 is next.
...
- `tmp/cleanup_plan.md`: active strict ROI-ranked cleanup backlog rebuilt on `2026-03-12`; items 1-7 complete, item 8 next
