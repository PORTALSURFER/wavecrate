...
3. Execute `tmp/cleanup_plan.md` Phase 2 strictly in order, with item 9 complete and item 10 next.
...
- `tmp/cleanup_plan.md`: ROI-ranked cleanup backlog + execution checklist (last refresh: 2026-03-09, 3 pending items; item 10 next)
