...
3. Execute `tmp/cleanup_plan.md` Phase 2 strictly in order, with item 10 complete and item 11 next.
...
- `tmp/cleanup_plan.md`: ROI-ranked cleanup backlog + execution checklist (last refresh: 2026-03-09, 2 pending items; item 11 next)
