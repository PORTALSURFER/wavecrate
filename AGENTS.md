...
- Source of truth: `tmp/improvement_audit_plan.md` for the completed ROI-ranked backlog and execution record; `docs/gui_test_platform.md`, `tmp/cleanup_plan.md`, and `tmp/perf_plan.md` remain relevant background plans
- Current status: the improvement-audit execution lane is complete on `2026-03-15`; items 1-9 are done, including browser scrollbar semantic automation coverage in `vendor/radiant`.
...
- `tmp/improvement_audit_plan.md`: refreshed evidence-driven ROI-ranked improvement backlog and execution record; items 1-9 are complete as of `2026-03-15`
