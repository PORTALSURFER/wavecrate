...
3. Execute `tmp/cleanup_plan.md` Phase 2 strictly in order, with item 11 complete and item 12 next.
...
- `tmp/cleanup_plan.md`: ROI-ranked cleanup backlog + execution checklist (last refresh: 2026-03-09, 1 pending item; item 12 next)
