...
- Current status: Phase 2 is active; cleanup items 1-5 are complete, and item 6 is next.
...
- `tmp/cleanup_plan.md`: active strict ROI-ranked cleanup backlog rebuilt on `2026-03-12`; items 1-5 complete, item 6 next
