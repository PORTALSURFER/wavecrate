...
3. Execute `tmp/cleanup_plan.md` Phase 2 strictly in order, with item 6 complete and item 7 next.
...
- `tmp/cleanup_plan.md`: ROI-ranked cleanup backlog + execution checklist (last refresh: 2026-03-09, 6 pending items; item 7 next)
