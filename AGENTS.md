...
- Current status: Phase 2 is active; cleanup item 1 is complete in `vendor/radiant` commit `f8063a2b`, and item 2 is next.
...
- `tmp/cleanup_plan.md`: active strict ROI-ranked cleanup backlog rebuilt on `2026-03-12`; item 1 complete in `vendor/radiant` commit `f8063a2b`, item 2 next
