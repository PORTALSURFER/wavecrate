...
- Current status: `tmp/perf_plan.md` is complete through item 11; `tmp/cleanup_plan.md` was refreshed on 2026-03-11 with a new second-pass cleanup backlog; Phase 2 is now in progress, items 1-12 are complete, and item 13 is next.

## Immediate Next Actions
1. Continue the refreshed cleanup backlog in strict order from item 13.
2. Record each cleanup item completion in `tmp/cleanup_plan.md` immediately after the code/tests are green.
...
- `tmp/cleanup_plan.md`: refreshed strict ROI-ranked cleanup backlog (Phase 2 in progress; items 1-12 complete, item 13 next)
