...
- Current status: Phase 2 is active on `2026-03-31`. Items 1-5 are implemented and validated, and item 6 (`app_core` native dispatch-hub splits) is next in sequence.
...
- `tmp/improvement_audit_plan.md`: refreshed evidence-driven ROI-ranked improvement backlog and execution record for the live tree; Phase 2 is active and items 1-5 are complete
