...
impl BrowserController<'_> {
    pub(in crate::app::controller::library::browser_controller::actions) fn tag_browser_sample_action(
        &mut self,
        row: usize,
    ...
    pub(in crate::app::controller::library::browser_controller::actions) fn tag_browser_samples_action(
        &mut self,
        rows: &[usize],
        tag: crate::sample_sources::Rating,
    ...
    pub(in crate::app::controller::library::browser_controller::actions) fn set_loop_marker_browser_samples_action(
        &mut self,
        rows: &[usize],
        looped: bool,
        primary_visible_row: usize,
    ...
    pub(in crate::app::controller::library::browser_controller::actions) fn set_bpm_browser_samples_action(
        &mut self,
        rows: &[usize],
        bpm: f32,
        primary_visible_row: usize,
