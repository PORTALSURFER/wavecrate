...
impl AppController {
    ...
    pub(super) fn store_waveform_image(&mut self, image: WaveformImage, meta: WaveformRenderMeta) {
        ...
        let projected_image: Option<Arc<radiant::gui::types::ImageRgba>> = image
            .size
            .iter()
        ...
        self.mark_waveform_image_projection_dirty();
    }
    ...
    pub(crate) fn store_prepared_waveform_image(
        ...
        projected_image: Option<Arc<radiant::gui::types::ImageRgba>>,
