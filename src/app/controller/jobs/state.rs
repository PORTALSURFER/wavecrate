...
pub(super) struct JobRequestCounters {
    ...
    pub(crate) next_source_remap_request_id: u64,
    ...
    pub(crate) next_waveform_transient_request_id: u64,
...
impl Default for JobRequestCounters {
    ...
    fn default() -> Self {
        Self {
            ...
            next_source_remap_request_id: 1,
            ...
            next_waveform_transient_request_id: 1,
