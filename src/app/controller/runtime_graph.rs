...
impl AppController {
    ...
    pub(crate) fn mark_derived_source_dirty(&mut self, source: DerivedNodeId, reason: DirtyReason) {
        self.runtime
            .projection
            .derived_graph
            .mark_source_dirty(source, reason);
    }
    ...
    pub(crate) fn has_dirty_derived_nodes(&self) -> bool {
        self.runtime.projection.derived_graph.has_dirty_nodes()
    }
    ...
    pub(crate) fn derived_dirty_reason(&self, node: DerivedNodeId) -> Option<DirtyReason> {
        self.runtime.projection.derived_graph.last_reason(node)
    }
    ...
    pub(crate) fn is_derived_node_dirty(&self, node: DerivedNodeId) -> bool {
        self.runtime.projection.derived_graph.is_dirty(node)
    }
