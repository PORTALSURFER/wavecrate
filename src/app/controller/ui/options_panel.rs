...
impl AppController {
    /// Open the ui-projection options panel.
    ...
    /// Close the ui-projection options panel.
    ...
    /// Toggle the ui-projection options panel visibility.
    ...
    /// Show the audio-options overview inside the ui-projection options panel.
    pub fn show_audio_options_overview(&mut self) {
        self.ui.options_panel.active_audio_picker = None;
    }

    /// Expand one audio picker inside the ui-projection options panel.
