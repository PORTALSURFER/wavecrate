...
pub(super) const TOGGLE_BPM_SNAP: HotkeyAction = HotkeyAction {
    ...
    scope: WAVEFORM,
    action: NativeUiAction::Options(crate::app_core::actions::NativeOptionsAction::ToggleBpmSnap),
};
pub(super) const TOGGLE_TRANSIENT_MARKERS: HotkeyAction = HotkeyAction {
    ...
    action: NativeUiAction::Options(
        crate::app_core::actions::NativeOptionsAction::ToggleTransientMarkers,
    ),
};
