...
pub(in crate::app_core::native_shell::composition::state) fn browser_rows_window_bounds_with_previous(
    layout: &ShellLayout,
    model: &AppModel,
    sizing: SizingTokens,
...
pub(in crate::app_core::native_shell::composition::state) fn browser_window_start_with_previous(
