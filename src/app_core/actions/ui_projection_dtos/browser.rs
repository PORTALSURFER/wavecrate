//! Browser projection DTOs for the Wavecrate UI projection.
...
/// Summary of browser/list state consumed by the UI projection.
...
/// Browser chrome copy used by the UI projection toolbar and tab strip.
