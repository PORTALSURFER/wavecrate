...
gui_action_catalog!(
    ...
    ToggleFolderFlattenedView {} => { id: "toggle_folder_flattened_view", surface: Sources, effect: Projection, coverage: [SemanticContract, RuntimeInput, ProjectionSnapshot], fixtures: ["sources"], sample: NativeUiAction::ToggleFolderFlattenedView },
