...
pub(in crate::app_core::ui_projection) fn browser_row_identity_hash(path: &Path) -> u64 {
    hash_scalar(path)
}
...
pub(in crate::app_core::ui_projection) fn refresh_projected_selected_paths_lookup(
...
pub(in crate::app_core::ui_projection) fn selected_index_is_selected(
...
pub(in crate::app_core::ui_projection) fn refresh_projected_browser_row_cache(
    controller: &mut AppController,
) {
...
pub(in crate::app_core::ui_projection) fn project_cached_browser_row(
    controller: &mut AppController,
    absolute_index: usize,
