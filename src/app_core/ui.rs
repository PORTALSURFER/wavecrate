...
/// Default viewport size used by the UI runtime host window.
pub const DEFAULT_VIEWPORT_SIZE: [f32; 2] = [960.0, 560.0];
/// Minimum viewport size used by the UI runtime host window.
pub const MIN_VIEWPORT_SIZE: [f32; 2] = [640.0, 400.0];

/// Maximum browser rows projected per UI frame.
///
...
/// Maximum map points projected per UI frame.
