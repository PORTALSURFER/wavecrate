...
pub(super) struct NativeProjectionCacheKey {
    ...
    pub(super) waveform_selection_start_micros: Option<u32>,
    pub(super) waveform_selection_end_micros: Option<u32>,
    pub(super) waveform_edit_selection_start_milli: Option<u16>,
    pub(super) waveform_edit_selection_end_milli: Option<u16>,
    pub(super) waveform_edit_selection_start_micros: Option<u32>,
    pub(super) waveform_edit_selection_end_micros: Option<u32>,
    ...
    pub(super) waveform_edit_fade_in_end_micros: Option<u32>,
    pub(super) waveform_edit_fade_in_mute_start_micros: Option<u32>,
    pub(super) waveform_edit_fade_out_start_micros: Option<u32>,
    pub(super) waveform_edit_fade_out_mute_end_micros: Option<u32>,
    pub(super) waveform_view_start_milli: u16,
    pub(super) waveform_view_end_milli: u16,
    pub(super) waveform_view_start_micros: u32,
    pub(super) waveform_view_end_micros: u32,
