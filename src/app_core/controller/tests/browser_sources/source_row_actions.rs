...
fn reload_source_row_action_uses_single_active_source_list() {
    ...
    controller.apply_ui_action(NativeUiAction::SourcesAndFolders(
        crate::app_core::actions::NativeSourcesFoldersAction::ReloadSourceRow { index: 1 },
    ));
...
fn remove_source_row_action_removes_clicked_source_from_single_list() {
    ...
    controller.apply_ui_action(NativeUiAction::SourcesAndFolders(
        crate::app_core::actions::NativeSourcesFoldersAction::RemoveSourceRow { index: 1 },
    ));
...
fn focus_source_row_action_selects_single_active_source_and_focuses_sources_list() {
    ...
    controller.apply_ui_action(NativeUiAction::SourcesAndFolders(
        crate::app_core::actions::NativeSourcesFoldersAction::FocusSourceRow { index: 1 },
    ));
...
fn focus_sources_panel_preserves_selected_source_row() {
    ...
    controller.apply_ui_action(NativeUiAction::Shell(
        crate::app_core::actions::NativeShellAction::FocusSourcesPanel,
    ));
