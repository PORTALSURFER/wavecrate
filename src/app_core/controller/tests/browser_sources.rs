...
#[test]
/// Native flattened-view toggle should switch folder filtering between direct files and descendants.
...
#[test]
/// Native root-folder activation should no longer change file scope on repeated clicks.
