//! Shared projection-key encoding utilities used by UI bridge key builders.
//!
...
/// Convert a normalized `f64` scalar into clamped nano-space (`0..=1_000_000_000`).
pub(super) fn normalized_f64_to_nanos(value: f64) -> u32 {
