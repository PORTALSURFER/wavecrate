...
pub(super) fn build_non_segment_static_projection_key(
    ...
    let audio_chip =
        crate::app_core::ui_projection::project_audio_engine_chip_model(&controller.ui);
    NonSegmentStaticProjectionCacheKey {
...
pub(super) fn build_non_segment_overlay_projection_key(
    ...
    let options_panel = crate::app_core::ui_projection::project_options_panel_model(&controller.ui);
    let progress_overlay =
        crate::app_core::ui_projection::project_progress_overlay_model(&controller.ui);
    let confirm_prompt =
        crate::app_core::ui_projection::project_confirm_prompt_model(&controller.ui);
    let drag_overlay = crate::app_core::ui_projection::project_drag_overlay_model(&controller.ui);
    let audio_engine_overlay_hash = if options_panel.visible {
        hash_audio_engine_model(&crate::app_core::ui_projection::project_audio_engine_model(
            &controller.ui,
        ))
    } else {
        0
