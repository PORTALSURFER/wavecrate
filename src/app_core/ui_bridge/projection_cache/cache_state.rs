...
use super::{
    ...
    ProjectionSegmentLookupCounts, StatusProjectionCacheKey, UiProjectionCacheKey,
    WaveformProjectionCacheKey, segment_materialize,
};
...
pub(crate) struct DerivedProjectionState {
    ...
    pub(crate) app_key: UiProjectionCacheKey,
...
pub(crate) struct UiProjectionCache {
    pub(crate) app_key: Option<UiProjectionCacheKey>,
