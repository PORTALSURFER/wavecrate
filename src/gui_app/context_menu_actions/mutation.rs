...
use super::super::{GuiAppState, GuiMessage, WaveformState, emit_gui_action};

impl GuiAppState {
    pub(in crate::gui_app) fn remove_context_source(&mut self) {
    ...
    pub(in crate::gui_app) fn delete_context_metadata_tag(
        &mut self,
