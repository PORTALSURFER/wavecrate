...
use super::super::{GuiAppState, emit_gui_action};

impl GuiAppState {
    pub(in crate::gui_app) fn open_source_context_menu(
        &mut self,
        source_id: String,
        position: Point,
    ) {
    ...
    pub(in crate::gui_app) fn open_folder_context_menu(
        &mut self,
        folder_id: String,
        position: Point,
    ) {
    ...
    pub(in crate::gui_app) fn open_sample_context_menu(&mut self, path: String, position: Point) {
        let started_at = Instant::now();
        self.folder_browser
    ...
    pub(in crate::gui_app) fn open_metadata_tag_context_menu(
        &mut self,
        tag: String,
        position: Point,
    ) {
