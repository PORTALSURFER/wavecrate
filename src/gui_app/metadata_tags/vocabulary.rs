...
pub(in crate::gui_app) fn commit_metadata_tag_text(value: &str) -> MetadataTagCommit {
    let parts = value
        .split(['\n', ',', ';'])
        .map(str::trim)
        .collect::<Vec<_>>();
...
pub(in crate::gui_app) fn normalize_metadata_tag(value: &str) -> Option<String> {
...
#[cfg(test)]
pub(in crate::gui_app) fn metadata_tag_completion<'a>(
    value: &str,
...
pub(in crate::gui_app) fn metadata_tag_completions_for_prefix<'a>(
    prefix: &str,
    known_tags: impl IntoIterator<Item = &'a str>,
) -> Vec<String> {
    known_tags
...
#[cfg(test)]
pub(in crate::gui_app) fn metadata_tag_category_id(tag: &str) -> &'static str {
    inferred_metadata_tag_category_id(tag)
}

pub(in crate::gui_app) fn inferred_metadata_tag_category_id(tag: &str) -> &'static str {
...
pub(in crate::gui_app) fn metadata_tag_category_order(category_id: &str) -> usize {
...
pub(in crate::gui_app) fn inferred_metadata_tag_category_id_for_name(tag: &str) -> &'static str {
    inferred_metadata_tag_category_id(tag)
}

pub(in crate::gui_app) fn metadata_tag_category_label_for_id(
    category_id: &str,
) -> Option<&'static str> {
    METADATA_TAG_CATEGORIES
        .iter()
...
pub(in crate::gui_app) fn static_metadata_tag_category_id(
    category_id: &str,
) -> Option<&'static str> {
    METADATA_TAG_CATEGORIES
        .iter()
...
pub(in crate::gui_app) fn metadata_tag_category_is_locked(category_id: &str) -> bool {
...
pub(in crate::gui_app) fn normalize_metadata_category_query(value: &str) -> Option<String> {
