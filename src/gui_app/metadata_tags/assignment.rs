...
impl GuiAppState {
    pub(in crate::gui_app) fn add_metadata_tags(
        &mut self,
        tags: Vec<String>,
    ...
    pub(in crate::gui_app) fn toggle_metadata_tag(
        &mut self,
        tag: String,
        context: &mut ui::UpdateContext<GuiMessage>,
    ) {
    ...
    pub(in crate::gui_app) fn remove_selected_metadata_tag(
        &mut self,
        context: &mut ui::UpdateContext<GuiMessage>,
    ) {
    ...
    pub(in crate::gui_app) fn finish_metadata_tag_persist(
        &mut self,
