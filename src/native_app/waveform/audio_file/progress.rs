...
pub(in crate::native_app::waveform) fn report_phase_progress_throttled(
    start: f32,
    end: f32,
    completed: usize,
    total: usize,
...
pub(in crate::native_app::waveform) fn cooperate_with_ui(completed: usize) {
    if completed == 0 {
        return;
    }
...
pub(in crate::native_app::waveform) fn report_phase_progress(
    start: f32,
    end: f32,
    completed: usize,
    total: usize,
