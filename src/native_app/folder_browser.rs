...
mod view;
#[cfg(test)]
pub(in crate::native_app::folder_browser) use view::COLLAPSED_FILTER_PANEL_HEIGHT;
pub(in crate::native_app::folder_browser) use view::DEFAULT_FILTER_PANEL_HEIGHT;
#[cfg(test)]
