...
fn sample_browser_column_drag_paints_drop_marker() {
    ...
    state.folder_browser.apply_message(
        crate::native_app::library_browser::folder_browser::FolderBrowserMessage::DragFileColumn(
            String::from("rating"),
...
fn sample_column_resize_updates_rendered_row_layout_without_sorting() {
    ...
    runtime.dispatch_message(crate::native_app::test_support::GuiMessage::FolderBrowser(
        crate::native_app::library_browser::folder_browser::FolderBrowserMessage::ResizeFileColumn(
            String::from("name"),
