...
pub(in crate::native_app::folder_browser) const COLLAPSED_FILTER_PANEL_HEIGHT: f32 =
    FILTER_PANEL_PADDING * 2.0 + FILTER_PANEL_HEADER_HEIGHT;
const MIN_FILTER_PANEL_HEIGHT: f32 = COLLAPSED_FILTER_PANEL_HEIGHT;
pub(in crate::native_app::folder_browser) const DEFAULT_FILTER_PANEL_HEIGHT: f32 = 76.0;
...
impl FolderBrowserState {
    ...
    pub(in crate::native_app::folder_browser) fn resize_filter_panel(
        &mut self,
