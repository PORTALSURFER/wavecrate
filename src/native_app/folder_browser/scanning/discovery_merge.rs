...
pub(in crate::native_app::folder_browser) fn merge_scan_discovery(
...
pub(in crate::native_app::folder_browser) fn upsert_folder(
...
pub(in crate::native_app::folder_browser) fn upsert_file(
