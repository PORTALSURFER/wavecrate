...
pub(in crate::native_app::browser::folder_browser) fn file_entry(path: &PathBuf) -> FileEntry {
    file_entry_with_metadata(path, Rating::NEUTRAL, false, Vec::new())
}

pub(in crate::native_app::browser::folder_browser) fn file_entry_with_metadata(
    path: &PathBuf,
    rating: Rating,
    rating_locked: bool,
