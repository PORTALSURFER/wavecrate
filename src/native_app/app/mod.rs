...
pub(in crate::native_app) use message::{
    AudioOutputPersistResult, BrowserProjectionDelta, BrowserScrollSurface,
    CommittedWatcherCoverage, GuiMessage, MetadataMessage, SettingsMessage,
    SimilaritySettingsPersistResult, SourceFilesystemSyncAuditReason, SourceFilesystemSyncResult,
...
pub(in crate::native_app) use state::{
    ...
    MIN_WAVEFORM_PANEL_HEIGHT, MetadataAppState, NativeAppState, OperationJournalRestoreCompletion,
    OperationJournalRestoreError, OperationJournalStatus, OverflowFadeAnimations,
    PendingFolderDelete, PendingHistoryCommit, PendingHistoryOwnerStaging,
