...
use self::cases::{
    ...
    browser_playback_age_filters_case, browser_refocus_after_down_scroll_keeps_single_focus_case,
    ...
    update_panel_actions_case, waveform_click_play_case,
