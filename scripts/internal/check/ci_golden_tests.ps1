...
if (Test-Path "assets\\ml\\panns_cnn14_16k\\golden_mel.json") {
    $env:WAVECRATE_PANNS_GOLDEN_PATH = "assets\\ml\\panns_cnn14_16k\\golden_mel.json"
}
if (Test-Path "assets\\ml\\panns_cnn14_16k\\golden_embedding.json") {
    $env:WAVECRATE_PANNS_EMBED_GOLDEN_PATH = "assets\\ml\\panns_cnn14_16k\\golden_embedding.json"
}
