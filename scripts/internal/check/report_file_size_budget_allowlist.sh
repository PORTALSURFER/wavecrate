...
LIMIT=400
ALLOWLIST_PATH="scripts/internal/check/allowlists/file_size_budget_allowlist.txt"

usage() {
  cat <<'EOF'
Usage: scripts/internal/check/report_file_size_budget_allowlist.sh [--limit <n>] [--allowlist <path>]
