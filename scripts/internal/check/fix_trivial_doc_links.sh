...
declare -a REWRITES=(
  "manual/gui_migration_parity.md" "docs/TARGET.md"
  "manual/legacy_ui_baseline.md" "docs/TARGET.md"
  "manual/performance_qa.md" "docs/TARGET.md"
  "manual/feature_vector.md" "docs/TARGET.md"
  "manual/ann_index_container.md" "docs/TARGET.md"
  "manual/updater-contract.md" "docs/TARGET.md"
  "manual/styleguide.md" "docs/TARGET.md"
  "manual/icon_assets.md" "docs/TARGET.md"
  "manual/hints.md" "docs/TARGET.md"
