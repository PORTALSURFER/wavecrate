...
$rewrites = @(
  @{ From = "manual/gui_migration_parity.md"; To = "docs/TARGET.md" },
  @{ From = "manual/legacy_ui_baseline.md"; To = "docs/TARGET.md" },
  @{ From = "manual/performance_qa.md"; To = "docs/TARGET.md" },
  @{ From = "manual/feature_vector.md"; To = "docs/TARGET.md" },
  @{ From = "manual/ann_index_container.md"; To = "docs/TARGET.md" },
  @{ From = "manual/updater-contract.md"; To = "docs/TARGET.md" },
  @{ From = "manual/styleguide.md"; To = "docs/TARGET.md" },
  @{ From = "manual/icon_assets.md"; To = "docs/TARGET.md" },
  @{ From = "manual/hints.md"; To = "docs/TARGET.md" },
