...
Write-Host "[gui-contract] cargo test gui_test::runner::tests -- --test-threads=1"
cargo test gui_test::runner::tests -- --test-threads=1
if ($LASTEXITCODE -ne 0) { throw "gui contract runner tests failed" }
