...
usage() {
  cat <<'USAGE'
Usage: scripts/agent/install_agent_preflight_hooks.sh [--force]
...
preflight_script="$repo_root/scripts/agent/run_agent_preflight.sh"
...
branch_guard="$repo_root/scripts/check/check_next_branch.sh"
