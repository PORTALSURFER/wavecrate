...
.DESCRIPTION
PowerShell equivalent of `scripts/agent/run_agent_ci_checks.sh`.
...
if ($Help) {
  Write-Host "Usage: scripts/agent/run_agent_ci_checks.ps1 [-RefreshMemory] [-Updater Codex] [-RequiredUpdater <name>] [-MemoryMaxAgeHours 24]"
  Write-Host ""
