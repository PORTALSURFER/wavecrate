...
- Exact dedupe: Click Exact Dedupe after setting BPM, review duplicate beats with Left/Right and Space, use Shift + D or M to refine the cleanup set, then click Clean Dups to remove later exact clones while keeping the first hit.
