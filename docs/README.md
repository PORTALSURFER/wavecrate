...
- `tmp/improvement_audit_plan.md` — completed evidence-driven ROI-ranked improvement backlog
  and execution record for the live codebase through item 9 on 2026-03-15
