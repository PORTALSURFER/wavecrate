...
- `tmp/improvement_audit_plan.md` - current evidence-driven ROI-ranked improvement backlog
  and execution record for the live codebase (Phase 2 started on 2026-03-29; item 11 is the next safe executable task after clarification-gated items 4-6 and 8-9)
