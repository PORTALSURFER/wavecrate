...
- `tmp/improvement_audit_plan.md` — refreshed evidence-driven ROI-ranked improvement audit backlog
  and open-questions record for the live codebase (Phase 1 complete on 2026-03-15; awaiting explicit Phase 2 confirmation)
