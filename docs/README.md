...
- `tmp/improvement_audit_plan.md` — refreshed evidence-driven ROI-ranked improvement audit execution record
  for the live codebase (Phase 2 complete on 2026-03-15)
