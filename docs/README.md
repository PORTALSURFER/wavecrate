...
- `tmp/improvement_audit_plan.md` — refreshed evidence-driven ROI-ranked improvement backlog
  for the live codebase (Phase 1 complete on 2026-03-17; awaiting explicit implementation confirmation)
