...
![Wavecrate main window](assets/wavecrate-main-window.png)
...
![Waveform area in the main window](assets/feature-waveform.png)
...
![Sample browser in the main window](assets/feature-sample-browser.png)
