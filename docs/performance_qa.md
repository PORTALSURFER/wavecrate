...
- Run `bash scripts/run_perf_guard.sh` (or `powershell -ExecutionPolicy Bypass -File scripts/run_perf_guard.ps1`) to execute deterministic benchmark scenarios for hover, wheel, map-pan proxy, waveform interactions, and volume drag interactions.
