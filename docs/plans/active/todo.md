...
Last updated (local): 2026-03-19T13:17:14+01:00
...
- `tmp/improvement_audit_plan.md` is the live execution tracker; items 1-4 are complete locally in commits `7e6baff1`, `c6b814d2`, `91e5c30e`, and the next local Windows-wrapper hardening commit, and item 5 is next.
...
1. Implement item 5 from `tmp/improvement_audit_plan.md`: enforce that `DesktopAiv` catalog coverage claims are backed by actual desktop-AIV cases.
