...
Last updated (local): 2026-03-19T14:22:46+01:00
...
- `tmp/improvement_audit_plan.md` is the live execution tracker; items 1-9 are complete locally, with commits recorded for items 1-8 in `7e6baff1`, `c6b814d2`, `91e5c30e`, `d0685aad`, `8b0637d7`, `78430bfa`, `6b24829d`, and `6a8c78bd`, and item 10 is next.
...
1. Implement item 10 from `tmp/improvement_audit_plan.md`: split `folder_moves.rs` so the module portal and worker-heavy tests stop sharing one hotspot file.
