...
Last updated (UTC): 2026-03-11T11:38:05Z
...
- The active ordered cleanup backlog lives in `tmp/cleanup_plan.md`; items 1-29 are complete, item 30 is next, and Phase 2 is in progress.
