...
Last updated (UTC): 2026-03-11T11:10:18Z
...
- The active ordered cleanup backlog lives in `tmp/cleanup_plan.md`; items 1-26 are complete, item 27 is next, and Phase 2 is in progress.
