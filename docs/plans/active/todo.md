...
- Completed ROI item #8: switched native-shell selected-path lookup refresh to
  selection-revision gating and wired revision bumps through browser
  selected-path mutation flows.
