...
Last updated (UTC): 2026-03-11T08:13:59Z
...
- The active ordered cleanup backlog lives in `tmp/cleanup_plan.md`; items 1-20 are complete, item 21 is next, and Phase 2 is in progress.
