...
Last updated (UTC): 2026-03-11T11:28:55Z
...
- The active ordered cleanup backlog lives in `tmp/cleanup_plan.md`; items 1-28 are complete, item 29 is next, and Phase 2 is in progress.
