...
1. Execute item 2 from `tmp/improvement_audit_plan.md`: re-synchronize mutable lane-state docs and add one lightweight consistency guard or single source of truth.
2. Continue the ranked backlog sequentially after item 2 and keep the ranked order and open questions honest as evidence changes.
