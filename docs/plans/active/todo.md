...
Last updated (UTC): 2026-03-11T10:59:13Z
...
- The active ordered cleanup backlog lives in `tmp/cleanup_plan.md`; items 1-25 are complete, item 26 is next, and Phase 2 is in progress.
