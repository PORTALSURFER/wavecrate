...
Last updated (UTC): 2026-03-11T11:17:46Z
...
- The active ordered cleanup backlog lives in `tmp/cleanup_plan.md`; items 1-27 are complete, item 28 is next, and Phase 2 is in progress.
